...
$sentencia = $bd->prepare("SELECT id, fecha, campus, campus_dir, numero, importe, personal, empresa, user_id, estado FROM entregaliquidaciones WHERE campus='".$campus."' ORDER BY id DESC");
