...
if($tipo_usuario=='SUPERVISOR'){
  ...
  $sentencia = $bd->prepare("SELECT id, codigo, fecha, area, encargado, sala, prioridad, motivo, id_asignado, estado FROM requerimientos WHERE estado='FINALIZADO' AND (".$salasString.") ORDER BY id DESC");
}
