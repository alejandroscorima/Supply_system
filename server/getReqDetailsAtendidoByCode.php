...
$sentencia = $bd->prepare("SELECT id, req_codigo, cantidad, descripcion, tipo, estado, image_url, id_asignado FROM req_detalles WHERE req_codigo='".$codigo."' AND estado='ATENDIDO'");
